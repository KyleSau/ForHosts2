...
const BlogCard: React.FC<BlogCardProps> = ({ blog }) => {
  return (
    <Link href={`/blogs/${blog.slug}`}>
      ...
      <div className="w-64 h-64 border border-black rounded-xl overflow-hidden shadow-lg m-4 cursor-pointer hover:scale-110 hover:bg-gray-100 flex flex-col justify-center items-center">
