  ...
  <section className="bg-white dark:bg-gray-900">
    <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div className="max-w-screen-md mb-8 lg:mb-16">
        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Full Featured Direct Booking Websites</h2>
      ...
      <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
        <div>
          ...
          <h3 className="mb-2 text-xl font-bold dark:text-white">Channel Management</h3>
        ...
        <div>
          ...
          <h3 className="mb-2 text-xl font-bold dark:text-white">Direct Booking Engine</h3>
        ...
        <div>
          ...
          <h3 className="mb-2 text-xl font-bold dark:text-white">Security Deposits</h3>
        ...
        <div>
          ...
          <h3 className="mb-2 text-xl font-bold dark:text-white">Live Chat Support</h3>
        ...
        <div>
          ...
          <h3 className="mb-2 text-xl font-bold dark:text-white">Beautifully Designed Websites</h3>
        ...
        <div>
          ...
          <h3 className="mb-2 text-xl font-bold dark:text-white">Lightning Fast Websites</h3>
