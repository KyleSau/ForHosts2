    ...
    <div className="h-[600px] bg-gray-300 flex items-center justify-center">
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-center">
        <div className="text-center w-full md:w-1/2">
          <h2 className="font-bold text-4xl text-gray-800 md:text-5xl">Direct Booking Websites Made Simple.</h2>
          <p className="mt-4 text-lg text-gray-600 dark:text-gray-400">ForHosts is the simplest way for short term rental owners to create a fully functional direct booking website without any technical skills required. 100% Free for hosts.</p>
