      ...
      <div>
        ...
        <div className="mb-5 mt-5 flex items-center justify-between text-sm font-medium leading-6 text-gray-900">
          ...
          <label className="relative inline-flex cursor-pointer items-center space-x-2">
            ...
            >
              <div
                className={`h-4 w-4 transform rounded-full bg-white shadow-md ${
                  formik.values.petsAllowed ? "translate-x-6" : "translate-x-0"
                }`}
              ></div>
            </div>
          </label>
        ...
        <div className="mb-5 mt-5 flex items-center justify-between text-sm font-medium leading-6 text-gray-900">
          ...
          <label className="relative inline-flex cursor-pointer items-center space-x-2">
            ...
            >
              <div
                className={`h-4 w-4 transform rounded-full bg-white shadow-md ${
                  formik.values.eventsAllowed ? "translate-x-6" : "translate-x-0"
                }`}
              ></div>
            </div>
          </label>
        ...
        <div className="mb-5 mt-5 flex items-center justify-between text-sm font-medium leading-6 text-gray-900">
          ...
          <label className="relative inline-flex cursor-pointer items-center space-x-2">
            ...
            >
              <div
                className={`h-4 w-4 transform rounded-full bg-white shadow-md ${
                  formik.values.smokingAllowed ? "translate-x-6" : "translate-x-0"
                }`}
              ></div>
            </div>
          </label>
        ...
        <div className="mb-5 mt-5 flex items-center justify-between text-sm font-medium leading-6 text-gray-900">
          ...
          <label className="relative inline-flex cursor-pointer items-center space-x-2">
            ...
            <div
              className={`h-6 w-12 bg-${
                formik.values.commercialPhotographyAllowed ? "black" : "gray-300"
              } rounded-full p-1 transition-transform duration-300`}
            >
              <div
                className={`h-4 w-4 transform rounded-full bg-white shadow-md ${
                  formik.values.commercialPhotographyAllowed ? "translate-x-6" : "translate-x-0"
                }`}
              ></div>
            </div>
          </label>
