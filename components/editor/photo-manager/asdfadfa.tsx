...
//     const updatedFileDataObjects = [
//       ...fileDataObjects,
//       ...initialBlobDataArray,
//     ];
...
//       const updatedMetadata = await uploadBlobMetadata(
//         blobResult,
//         arrayIndex,
//         postId,
//         siteId,
...
//               <div className=" w-full border" key={image.id}>
...
//                             <div
//                               className="flex cursor-pointer items-center justify-center rounded-full border bg-gray-100 p-2 opacity-75 shadow-sm transition duration-300 ease-in-out hover:scale-110 hover:bg-white hover:opacity-100"
//                               style={{
//                                 width: "36px",
//                                 height: "36px",
//                               }}
